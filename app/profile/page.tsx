    ...
    <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          <div className="relative drop-shadow-2 flex justify-center items-center">
            <Image
              src={userSix}
              alt="profile"
              className="-mt-40 shadow-2xl rounded-full p-3  bg-gray-400"
            />
            <label
              htmlFor="profile"
              className="absolute bottom-0 left-[55%]  h-8.5 w-8.5 cursor-pointer  rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
            >
              <CameraIcon className="h-15 w-14 rounded-sm  " fill="#03045e" />
              <input
                type="file"
                name="profile"
                id="profile"
        ...
        <div className="mt-4 flex flex-col space-y-3">
          <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white flex items-center justify-center">
            Danish Heilium{" "}
            <CheckBadgeIcon
            ...
            />
            {/* <Image src={checkSvg} width={10} height={10} alt="Check Icon" /> */}
          </h3>
          <p className="font-medium">Ui/Ux Designer</p>
          <div className=" w-1/2 mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
